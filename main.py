...
def slide_f4():
    ...
    f4.shapes.add_picture(f"{path_f4}/{fecha_corte}_tendencia_creacion_f4_x_años.png", Cm(2.01),Cm(0.58),width = Cm(16.17), height = Cm(9.08)   )
    f4.shapes.add_picture(f"{path_f4}/{fecha_corte}_grafica_f4_sem.png", Cm(19.55), Cm(0.57), width = Cm(13.29), height = Cm(9.6))
    f4.shapes.add_picture(f"{path_f4}/{fecha_corte}_grafica_total_por_mes.png", Cm(13.03), Cm(10.07), width = Cm(7.62), height = Cm(7.62)   )
    f4.shapes.add_picture(f"{path_f4}/{fecha_corte}_torta.png", Cm(22.84), Cm(10.23), width = Cm(10), height = Cm(7.13))
    ...
    tx_estados.text = f"Tienda {f4_tienda}/nCD {f4_cd}/nDVD {f4_dvd}/nVenta empresa {f4_venta}"
    ...
    tx_registrados.text = f"Estado Registrado $21M < 7 días No han pasado a contabilidad,/nya informados a responsables/nUsuarios de creación:/n    -Jhonatan Beltran Velasquez/n   -Alexis Fabian Mestizo Parra"
    ...
    tx_registrados_m.text = f"Estado Registrado $2M >7 días No han pasado a contabilidad,/nya informados a responsables/nUsuarios de creación:/n  Jair Armando Rocha Vargas"
    tx_registrados_m.font.size= Pt(13)       

def f4_pos_causa():
    f4_pos_causa = seguimiento_fs.slides[9]
    f4_pos_causa.shapes.add_picture(f"{path_f4}/{fecha_corte}_clasificacion_posibles_causas_22.png", Cm(1.36),Cm(0.38),width = Cm(31.91), height = Cm(17.32))
...
def f4_mot_sede():
    ...
    f4_mot_sede.shapes.add_picture(f"{path_f4}/{fecha_corte}_grafica_total.png", Cm(0.66),Cm(2.32),width = Cm(17.41), height = Cm(14.81))
    f4_mot_sede.shapes.add_picture(f"{path_f4}/{fecha_corte}_grafica_total_por_mes.png", Cm(22.38), Cm(1.01), width = Cm(7.62), height = Cm(7.62))
    f4_mot_sede.shapes.add_picture(f"{path_f4}/{fecha_corte}_grafica_total_por_local.png", Cm(18.55), Cm(8.52), width = Cm(14.18), height = Cm(8.94))
...
def f4_mes_moti():
    ...
    f4_mes_moti.shapes.add_picture(f"{path_f4}/{fecha_corte}_cd_mm.png", Cm(19.5),Cm(0.61),width = Cm(11.59), height = Cm(8.27))
    f4_mes_moti.shapes.add_picture(f"{path_f4}/{fecha_corte}_tienda_mes_motivo.png", Cm(19.13),Cm(9.19),width = Cm(11.72), height = Cm(8.38))

def f4_linea_año():
    f4_linea_año = seguimiento_fs.slides[12]
    f4_linea_año.shapes.add_picture(f"{path_f4}/{fecha_corte}_torta_linea.png", Cm(1.61),Cm(2.26),width = Cm(13.18), height = Cm(15.06))
    f4_linea_año.shapes.add_picture(f"{path_f4}/{fecha_corte}_grafica_linea_x_mes.png", Cm(14.79),Cm(1.89),width = Cm(17.46), height = Cm(15.27))
...
def f4_linea_motivo():
    ...
    f4_linea_motivo.shapes.add_picture(f"{path_f4}/{fecha_corte}_linea_local.png", Cm(15.56),Cm(1.61),width = Cm(17.66), height = Cm(15.41))

def f4_averias():
    f4_linea_motivo = seguimiento_fs.slides[14]
    f4_linea_motivo.shapes.add_picture(f"{path_f4}/{fecha_corte}_grafica_averia_x_mes_y_marca.png", Cm(0),Cm(2.4),width = Cm(16.64), height = Cm(13.82))

def f4_calidad():
    f4_calidad = seguimiento_fs.slides[15]
    f4_calidad.shapes.add_picture(f"{path_f4}/{fecha_corte}_marca_calidad.png", Cm(0),Cm(2.4),width = Cm(16.64), height = Cm(13.82))

def f4_panatallas_rotas():
    f4_panatallas_rotas = seguimiento_fs.slides[16]
    f4_panatallas_rotas.shapes.add_picture(f"{path_f4}/{fecha_corte}_pantallas_rotas.png", Cm(0),Cm(4.1),width = Cm(19.73), height = Cm(12.33))
...
f4_calidad()
f4_panatallas_rotas()
seguimiento_fs.save(f"C:/Users/ext_maperezr/OneDrive - Falabella/General/SEGUIMIENTO-FS/cortes/{fecha_corte}_corte/{fecha_corte}seguimiento_fs.pptx")
